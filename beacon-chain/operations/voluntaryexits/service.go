...
// NewService instantiates a new voluntary exit pool service instance that will
...
// Start a voluntary exit pool service's main event loop.
func (s *Service) Start() {
	//go s.prepareForkChoiceAtts()
	//	go s.aggregateRoutine()
}

// Stop the beacon block volunary exit pool service's main event loop
