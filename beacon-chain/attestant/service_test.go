...
//func TestReceivesNewChainHeadEvent(t *testing.T) {
...
//}
//
//func TestOnlyArchiveAtEpochEnd(t *testing.T) {
//	hook := logTest.NewGlobal()
//	svc, beaconDB := setupService(t)
//	defer dbutil.TeardownDB(t, beaconDB)
...
//}
//
//func TestComputesAndSavesParticipation(t *testing.T) {
//	hook := logTest.NewGlobal()
...
//}
//
//func TestSavesIndicesAndBalances(t *testing.T) {
//	hook := logTest.NewGlobal()
//	validatorCount := uint64(100)
//	headState := setupState(t, validatorCount)
//	svc, beaconDB := setupService(t)
...
//}
//
//func TestSavesCommitteeInfo(t *testing.T) {
//	hook := logTest.NewGlobal()
//	validatorCount := uint64(100)
//	headState := setupState(t, validatorCount)
//	svc, beaconDB := setupService(t)
...
//}
//
//func TestSavesActivatedValidatorChanges(t *testing.T) {
//	hook := logTest.NewGlobal()
//	validatorCount := uint64(100)
//	headState := setupState(t, validatorCount)
//	svc, beaconDB := setupService(t)
...
//}
//
//func TestSavesSlashedValidatorChanges(t *testing.T) {
//	hook := logTest.NewGlobal()
//	validatorCount := uint64(100)
//	headState := setupState(t, validatorCount)
//	svc, beaconDB := setupService(t)
...
//}
//
//func TestSavesExitedValidatorChanges(t *testing.T) {
//	hook := logTest.NewGlobal()
//	validatorCount := uint64(100)
//	headState := setupState(t, validatorCount)
//	svc, beaconDB := setupService(t)
